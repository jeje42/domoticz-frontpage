Domotica = {
	...
	dashboard: {
		init: function() {
			...
			var langage = Domotica.settings.domoticz.langage
			if(langage){
		...
		defaultUI: {
			...
			textesRam: function(){
				$( ".text.ram-ui").each(function(idx,el) {
					// Add icon
					$(el).prepend(
						$("<span>" ).addClass( "info-box-icon" )
							.append( $( "<i>" ).addClass( "fa fa-memory") )
					);
			...
			//hdd
			switchesBackup: function() {
				$( ".switch.hdd-ui").each(function(idx,el) {
					// Add icon
					$(el).prepend(
						$("<span>" ).addClass( "info-box-icon" )
							.append( $( "<i>" ).addClass( "fa fa-hdd") )
					);
			...
			switchesJejeServeur: function() {
				$( ".switch.serveur-ui").each(function(idx,el) {
					// Add icon
					$(el).prepend(
						$("<span>" ).addClass( "info-box-icon" )
